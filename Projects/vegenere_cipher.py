...
def main():
    print('''\nVigenère Cipher, by Jayden
The Vigenere Cipher is a very powerful way of encrypting a password.
It even can be remain unbroken for CENTERIES unless you know the key.''')
    ...
    print('\nEnter the message to {}.'.format(myMode))
    myMessage = input('> ')
